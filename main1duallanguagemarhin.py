...
# #     'as-IN': 'as',   # Assamese
# #     'ne-IN': 'ne',   # Nepali
# #     'si-LK': 'si',   # Sinhala (spoken by a section of the Indian population, especially in Sri Lanka)
# #     'hi-PK': 'hi',   # Hindi (Pakistan variant)
# #     'mr-PK': 'mr',   # Marathi (spoken in Pakistan as well)
# #     'ta-LK': 'ta',   # Tamil (spoken in Sri Lanka)
# # #      Add other regional languages if required.
# # #          'es-ES': 'es',
# # #          'fr-FR': 'fr',
# # #          'ko-KR': 'ko', 
# # #          'fa-IR': 'fa', 
